...
section reedy
  ...
  section MO_facts
    ...
    ∀ y, object X (obj (red_coslice_obs.to ((@red_coslice_without_z_equiv  _ _ _ _ inj_φ max_rank _ _) ∙ y))) = 
    ...
    begin
      let  ψ := @red_coslice_without_z_equiv C z _ φ inj_φ max_rank _ _,
      ...
      unfold one_funct at *, unfold Functor_from_C' at *, 
